...
void SZ_decompression_in_time(char * filename, int snapshot_num, int interval, int n1, int n2, int n3){
	...
	free(ori_data);
	free(comp_data);
	std::cout << "SZST decompression time: " << elapsed_time << "  sdecompression rate: " << n1*n2*n3 * sizeof(Type) * 1.0 * interval_num * interval / elapsed_time / 1024 / 1024 << "MB/s" << std::endl;
}
...
void decimation_interpolate_in_time_and_space(char * filename, int snapshot_num, int interval, int snapshot_blocksize, int n1, int n2, int n3, int option){
	...
	free(dec_data);
	std::cout << "DST decompression time: " << elapsed_time << "  sdecompression rate: " << n1*n2*n3 * sizeof(Type) * 1.0 * interval_num * interval / elapsed_time / 1024 / 1024 << "MB/s" << std::endl;
}
...
void SZ_decompress_snapshot_and_interpolate_in_time(char * filename, int snapshot_num, int interval, int n1, int n2, int n3, int option){
	...
	free(dec_data);
	SZ_Finalize();
	std::cout << "SZSDT decompression time: " << elapsed_time << "  sdecompression rate: " << n1*n2*n3 * sizeof(Type) * 1.0 * interval_num * interval / elapsed_time / 1024 / 1024 << "MB/s" << std::endl;
}
...
void interpolate_snapshot_and_SZ_decompression_in_time(char * filename, int snapshot_num, int interval, int snapshot_blocksize, int n1, int n2, int n3, int option){
	...
	free(ori_data);
	free(comp_data);
	std::cout << "DSSZT decompression time: " << elapsed_time << "  sdecompression rate: " << n1*n2*n3 * sizeof(Type) * 1.0 * interval_num * interval / elapsed_time / 1024 / 1024 << "MB/s" << std::endl;
}
